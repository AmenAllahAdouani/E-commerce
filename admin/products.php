...
if(isset($_POST['add_product'])){
   ...
   $remise = $_POST['remise'];
   $remise = filter_var($remise, FILTER_SANITIZE_STRING);
   $price = $_POST['price'];
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, remise, details, price, image_01, image_02, image_03, image_04, image_05) VALUES(?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $price, $image_01, $image_02, $image_03, $image_04, $image_05]);
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>product price remise (required)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="enter product price remise" onkeypress="if(this.value.length == 10) return false;" name="remise">
         </div>
         <div class="inputBox">
